...
> 
> 📚 with [DigitalOcean Copy & Paste Commands](#digitalOcean-droplet)
> 
...
and removes the outlier before aggregation. Running the poisoning demo was performed in a different lab.
It has not been tested alongside Tool 4.
...
I have a quick start or offline mode where no Mininet is needed.
...
This section is in progress. This is not the main tool and not tested.
